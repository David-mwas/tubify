...
function Header() {
  return (
    <header className="sticky top-0 z-[999] left-0 right-0  px-4 md:px-0 bg-white/80 backdrop-blur-sm border-b border-gray-200">
          ...
          <div className="flex items-center">
            ...
            <SignedOut>
              <SignInButton mode="modal">
                <Button
                  variant="ghost"
                  className="mr-4 bg-gradient-to-r from-blue-600 to-blue-400 text-gray-200"
                >
                  Sign in
                </Button>
              </SignInButton>
